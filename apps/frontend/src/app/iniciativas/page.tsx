...
export default async function InitiativesPage() {
  ...
  return (
    <AppShell
      ...
      searchPlaceholder="Buscar iniciativas activas..."
    ...
    >
      <main className="px-container-padding py-8">
        <div className="mb-bento-gap flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link className="rounded-full bg-primary px-5 py-3 text-label-lg font-label-lg text-on-primary" href="/org-panel/nueva-iniciativa">
            Publicar iniciativa
          </Link>
        </div>
