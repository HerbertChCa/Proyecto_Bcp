  ...
  return (
    <main className="min-h-screen bg-background px-container-padding py-12 text-on-background md:px-8">
      <section className="mx-auto max-w-4xl rounded-[24px] border border-outline-variant/30 bg-surface-container-lowest p-8 shadow-sm md:p-12">
        <p className="text-label-md font-label-md uppercase tracking-[0.18em] text-secondary">Términos</p>
        <h1 className="mt-3 text-headline-lg font-headline-lg text-primary">Condiciones de uso</h1>
        <p className="mt-4 text-body-lg font-body-lg text-on-surface-variant">
          Al usar LánZate aceptas respetar las reglas de participación, convivencia y publicación responsable de iniciativas.
        </p>
        <p className="mt-4 text-body-md font-body-md text-on-surface-variant">
          La ruta existe para completar el flujo de navegación general y mantener consistencia con el footer de la aplicación.
        </p>
